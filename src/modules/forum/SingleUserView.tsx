...
const SingleUserViewModule = (props:any) => {
    ...
    useEffect(() => {
        const fetchPost = async () => {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/posts/get/${props.post_id}`, {
                    method: 'GET',
                    headers: {
...
export default SingleUserViewModule;